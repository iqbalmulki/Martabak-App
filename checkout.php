...
<body>
    ...
    <div class="site-wrapper">
        ...
        <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="<?php echo file_exists('images/food-mania-logo.png') ? 'images/food-mania-logo.png' : 'admin/images/food-mania-logo.png'; ?>?v=<?php echo time(); ?>" alt="FOODMANIA"> </a>
