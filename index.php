...
<body class="home">
                ...
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> 
                        <img class="img-rounded" 
                             src="<?php echo file_exists('images/food-mania-logo.png') ? 'images/food-mania-logo.png' : 'admin/images/food-mania-logo.png'; ?>?v=<?php echo time(); ?>" 
                             alt="FOODMANIA"> 
                    </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Pemesanan Pengiriman & Take-Out </h1>
                    ...
                    <div class="steps">
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Pesan Martabak</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Delivery atau take out</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Menu paling favorit bulan ini</h2>
                    <p class="lead">Cara paling mudah untuk memesan menu paling favorit</p>
                </div>
                <div class="row">
						<?php 					
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>Menyediakan berbagai restoran.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Pick up atau Delivery</h3>
                                <p>Pesanan martabak Kamu akan diantar! Nikmati martabak Kamu! </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Restoran yang direkomendasikan</h4> </div>
                    </div>
                    <div class="col-sm-8">
						...
						$ress= mysqli_query($db,"select * from restaurant");  
							      while($rows=mysqli_fetch_array($ress))
								  {
											...
											$query= mysqli_query($db,"select * from res_category where c_id='".$rows['c_id']."' ");
											 ...
											 $catSlug = category_slug($rowss['c_name']);
									
											 echo ' <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all '.$catSlug.'">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>54, Jl. Raya Manonjaya, Tasikmalaya, Cibeurem 46196, Indonesia</p>
                                    <h5>Phone: +62 813 2473 3992</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Tempat memesan martabak secara online.</p>
                                </div>
                    </div>
                </div>
    ...
    <script>
      // Normalisasi data-filter kategori agar sesuai dengan kelas slug di kartu restoran
      document.addEventListener('DOMContentLoaded', function () {
        var links = document.querySelectorAll('.restaurants-filter nav.primary ul li a[data-filter]');
        links.forEach(function (a) {
          var text = a.textContent.trim();
          if (text.toLowerCase() === 'all') { a.setAttribute('data-filter', '*'); return; }
          var slug = text.toLowerCase().replace(/[\s_]+/g, '-').replace(/[^a-z0-9-]/g, '');
          a.setAttribute('data-filter', '.' + slug);
        });
      });
    </script>
